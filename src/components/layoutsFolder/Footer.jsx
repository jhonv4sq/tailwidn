  ...
  <section class="flex flex-col gap-5 center md:flex md:flex-row md:gap-5 md:space-x-9 ">
      ...
      <div class="  space-y-5 md:space-y-5 ">
        ...
        <section>
          ...
          <p>
            © 2022 Bopart  · 
            <a class="hover:text-colorTourq" href="">
